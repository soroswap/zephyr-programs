...
pub extern "C" fn on_close() {
    ...
    let lpRouterContract = stellar_strkey::Contract::from_string("CBQDHNBFBZYE4MKPWBSJOPIYLW4SFSXAXUTSXJN76GNKYVYPCKWC6QUK").unwrap().0;
    let entries = env.read_contract_entries(lpRouterContract).unwrap();
