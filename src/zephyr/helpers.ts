...
export const getMercuryPools = async (network: Network) => {
  try {
    ...
    throw new Error("Failed to fetch Mercury pools");
  }
};
...
export const getMercuryPhoenixPools = async (network: Network) => {
  try{
    ...
    console.error("An error occurred:", err);
    throw new Error("Failed to fetch Mercury Phoenix pools");
  }
};
...
export const getMercuryAquaPools = async (network: Network) => {
  try{
    ...
    console.error("An error occurred:", err);
    throw new Error("Failed to fetch Mercury Aqua pools");
  }
};
...
export const getMercuryRsvCh = async (network: Network) => {
  try{
    ...
    console.error("An error occurred:", err);
    throw new Error("Failed to fetch Mercury Reserve changes");
  }
};
...
export const getMercuryEvents = async (network: Network) => {
  try{
    ...
    console.error("An error occurred:", err);
    throw new Error("Failed to fetch Mercury Events");
  }
};
